...
type QueryUsersOnlineRsp struct {
	...
	RspCode uint32 `protobuf:"varint,1,opt,name=rspCode,proto3" json:"rspCode,omitempty"`
...
func (x *QueryUsersOnlineRsp) GetRspCode() uint32 {
	if x != nil {
		return x.RspCode
	}
	return 0
...
type SendMsgReq struct {
	...
	SysAccount  string   `protobuf:"bytes,1,opt,name=sysAccount,proto3" json:"sysAccount,omitempty"`   // 用户ID
	AppPlatform string   `protobuf:"bytes,2,opt,name=appPlatform,proto3" json:"appPlatform,omitempty"` // 用户ID
	UserIds     []string `protobuf:"bytes,3,rep,name=userIds,proto3" json:"userIds,omitempty"`
	Acc         []byte   `protobuf:"bytes,4,opt,name=acc,proto3" json:"acc,omitempty"` // 用户ID
}
...
func (x *SendMsgRsp) GetRspCode() uint32 {
	if x != nil {
		return x.RspCode
	}
	return 0
...
func (x *ClearClientReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClearClientReq) ProtoMessage() {}

func (x *ClearClientReq) ProtoReflect() protoreflect.Message {
	mi := &file_im_protobuf_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClearClientReq.ProtoReflect.Descriptor instead.
func (*ClearClientReq) Descriptor() ([]byte, []int) {
	return file_im_protobuf_proto_rawDescGZIP(), []int{4}
}

func (x *ClearClientReq) GetSysAccount() string {
	if x != nil {
		return x.SysAccount
	}
	return ""
...
func (x *ClearClientReq) GetAppPlatform() string {
	if x != nil {
		return x.AppPlatform
	}
	return ""
...
func (x *ClearClientReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ClearClientRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClearClientRsp) ProtoMessage() {}

func (x *ClearClientRsp) ProtoReflect() protoreflect.Message {
	mi := &file_im_protobuf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClearClientRsp.ProtoReflect.Descriptor instead.
func (*ClearClientRsp) Descriptor() ([]byte, []int) {
	return file_im_protobuf_proto_rawDescGZIP(), []int{5}
}

func (x *ClearClientRsp) GetRspCode() uint32 {
	if x != nil {
		return x.RspCode
	}
	return 0
...
func (x *ClearClientRsp) GetErrMsg() string {
	if x != nil {
		return x.ErrMsg
	}
	return ""
...
func (x *GetUserListRsp) GetRspCode() uint32 {
	if x != nil {
		return x.RspCode
	}
	return 0
...
func (x *GetUserListRsp) GetUserIds() []string {
	if x != nil {
		return x.UserIds
	}
	return nil
...
var file_im_protobuf_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x52, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x73, 0x70, 0x43, 0x6f, 0x64, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x72, 0x73, 0x70, 0x43, 0x6f, 0x64, 0x65, 0x12,
	...
	,
	...
	0x67, 0x52, 0x73, 0x70, 0x22, 0x00, 0x12, 0x43, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	...
	0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x73, 0x70, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x11, 0x43,
	0x6c, 0x65, 0x61, 0x72, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x12, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x43, 0x6c, 0x65, 0x61,
	0x72, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x18, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x43, 0x6c, 0x69, 0x65, 0x6e,
	0x74, 0x52, 0x73, 0x70, 0x22, 0x00, 0x42, 0x2c, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x70,
...
var file_im_protobuf_proto_goTypes = []interface{}{
	...
	(*ClearClientReq)(nil),      // 4: protobuf.ClearClientReq
	(*ClearClientRsp)(nil),      // 5: protobuf.ClearClientRsp
...
var file_im_protobuf_proto_depIdxs = []int32{
	...
	4, // 3: protobuf.AccServer.ClearExistsClient:input_type -> protobuf.ClearClientReq
	...
	7, // 6: protobuf.AccServer.GetUserList:output_type -> protobuf.GetUserListRsp
	5, // 7: protobuf.AccServer.ClearExistsClient:output_type -> protobuf.ClearClientRsp
...
type AccServerClient interface {
	...
	// 获取用户列表
	ClearExistsClient(ctx context.Context, in *ClearClientReq, opts ...grpc.CallOption) (*ClearClientRsp, error)
}
...
func (c *accServerClient) ClearExistsClient(ctx context.Context, in *ClearClientReq, opts ...grpc.CallOption) (*ClearClientRsp, error) {
	out := new(ClearClientRsp)
	err := c.cc.Invoke(ctx, "/protobuf.AccServer/ClearExistsClient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccServerServer interface {
	...
	// 获取用户列表
	ClearExistsClient(context.Context, *ClearClientReq) (*ClearClientRsp, error)
}
...
func (*UnimplementedAccServerServer) ClearExistsClient(context.Context, *ClearClientReq) (*ClearClientRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ClearExistsClient not implemented")
}
...
func _AccServer_ClearExistsClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearClientReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccServerServer).ClearExistsClient(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.AccServer/ClearExistsClient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccServerServer).ClearExistsClient(ctx, req.(*ClearClientReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AccServer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ClearExistsClient",
			Handler:    _AccServer_ClearExistsClient_Handler,
		},
	},
