...
<div class="mobile-page">
    ...
    <script type="text/javascript">
        ...
        function addUserList(name) {
            music = "<li id=\"" + name + "\" class=''>" + name + "</li>";
        ...
        function sendMsg() {
            ...
            var flag
            $(".personnel-list-ul li").each(function () {
        ...
        //列表点击事件
        $(".personnel-list-ul").on("click", "li", function () {
            $(".personnel-list-ul li").removeClass("on")
            $(this).addClass("on")
